<a name="readme-top"><h1 align="center">OOP School Library</h1></a>
...
```sh
  git clone https://github.com/theodoku/OOP-school-library.git
  cd school-library
```
...
Feel free to check the [issues page](https://github.com/theodoku/OOP-school-library/issues).
